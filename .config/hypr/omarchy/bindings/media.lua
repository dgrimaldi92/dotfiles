...
o.bind(
	...
	"Volume up",
	"omarchy-audio-up --output-volume raise",
	{ locked = true, repeating = true }
) --TODO
o.bind("XF86AudioLowerVolume", "Volume down", "omarchy-audio-down", { locked = true, repeating = true })
o.bind("XF86AudioMute", "Mute", "omarchy-swayosd-client", { locked = true, repeating = true })
