...
type OperatorPositionConfig = "start" | "end";
type HtmlWhitespaceSensitivityConfig = "css" | "strict" | "ignore";
type JsdocUserConfig = boolean | JsdocConfig;
type CommentLineStrategyConfig = "singleLine" | "multiline" | "keep";
type LineWrappingStyleConfig = "greedy" | "balance";
 ...
 */
type ImportModifierConfig = "side_effect" | "type" | "value" | "default" | "wildcard" | "named";
/**
 * Selector matching the import kind in `customGroups` (see `sortImports.groups` for semantics).
 */
type ImportSelectorConfig = "type" | "side_effect_style" | "side_effect" | "style" | "index" | "sibling" | "parent" | "subpath" | "internal" | "builtin" | "external" | "import";
 ...
 */
export declare function defineConfig<T extends OxfmtConfig>(config: T & OxfmtConfig): T;
/**
 * Format the given source text according to the specified options.
 */
export declare function format(fileName: string, sourceText: string, options?: FormatConfig): Promise<FormatResult>;
/**
 * Format a JS/TS snippet for Prettier `textToDoc()` plugin flow.
 */
export declare function jsTextToDoc(sourceExt: string, sourceText: string, oxfmtPluginOptionsJson: string, parentContext: string): Promise<string | null>;
//#endregion
export type { ArrowParensConfig, CommentLineStrategyConfig, CustomGroupItemConfig, EmbeddedLanguageFormattingConfig, EndOfLineConfig, FormatConfig, GlobSet, HtmlWhitespaceSensitivityConfig, ImportModifierConfig, ImportSelectorConfig, JsdocConfig, JsdocUserConfig, LineWrappingStyleConfig, NewlinesBetweenMarker, ObjectWrapConfig, OperatorPositionConfig, OxfmtOverrideConfig, Oxfmtrc, ProseWrapConfig, QuotePropsConfig, SortGroupItemConfig, SortImportsConfig, SortImportsUserConfig, SortOrderConfig, SortPackageJsonConfig, SortPackageJsonUserConfig, SortTailwindcssConfig, SortTailwindcssUserConfig, SvelteConfig, SvelteUserConfig, TrailingCommaConfig };