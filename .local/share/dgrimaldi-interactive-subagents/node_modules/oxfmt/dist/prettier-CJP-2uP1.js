...
var init_prettier = __esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			name: "acorn",
			load: () => import("./acorn-rEwvRUzq.js"),
			parsers: ["acorn", "espree"]
		}, {
			name: "angular",
			load: () => import("./angular-BNqhpOOn.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_directive",
			...
			name: "markdown",
			load: () => import("./markdown-BMigo7Hm.js"),
			...
			name: "meriyah",
			load: () => import("./meriyah--O9OPfEs.js"),
			parsers: ["meriyah"]
		}, {
			name: "postcss",
			load: () => import("./postcss-DQ37ghU5.js"),
			...
			name: "typescript",
			load: () => import("./typescript-58lui7HM.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
