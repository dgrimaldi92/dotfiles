...
//#region ../../node_modules/.pnpm/prettier@3.9.6/node_modules/prettier/plugins/babel.mjs
...
function ns(a, e, t, s, i, r, n, o, h, c) {
	...
	for (let D = 0, v = r ?? 1 / 0; D < v; ++D) {
		...
		if (E >= 97 ? I = E - 97 + 10 : E >= 65 ? I = E - 65 + 10 : Yi(E) ? I = E - 48 : I = 1 / 0, I >= i) {
			if (I <= 9 && c) return {
				n: null,
				pos: e
			};
			...
			switch (Kr(o, i, t), o.type) {
				case "ParenthesizedExpression": {
					...
					if (s !== "oxc-ts") {
						if (!n) {
							n = [];
							for (let d of i) ws(d) && n.push(k(d));
						}
						let f = bs(0, n, (d) => d <= c);
						p = f && t.slice(f, c).trim().length === 0;
					}
					return p ? void 0 : (h.extra = {
						...h.extra,
						parenthesized: !0
					}, h);
				}
				...
				case "TemplateElement":
					if (s === "flow" || s === "hermes" || s === "espree" || s === "typescript" || s === "oxc-ts" || s === "yuku-ts") o.range = [N(o) + 1, k(o) - (o.tail ? 1 : 2)];
					break;
				case "TSParenthesizedType": return o.typeAnnotation;
				case "TopicReference":
					a.extra = {
						...a.extra,
				...
				case "TupleTypeAnnotation":
					...
					break;
				case "ImportDeclaration": s === "hermes" && o.assertions && !o.attributes && (o.attributes = o.assertions, delete o.assertions);
			}
		},
		onLeave(o) {
			switch (o.type) {
				case "LogicalExpression": if (Rs(o)) return ve(o);
			}
		}
	}), a;
}
		...
		toAssignable(e, t = !1) {
			...
			switch ((e.type === "ParenthesizedExpression" || e.extra?.parenthesized) && (s = fe(e), t ? s.type === "Identifier" ? this.expressionScope.recordArrowParameterBindingError(l.InvalidParenthesizedAssignment, e) : s.type !== "CallExpression" && s.type !== "MemberExpression" && !this.isOptionalMemberExpression(s) && this.raise(l.InvalidParenthesizedAssignment, e) : this.raise(l.InvalidParenthesizedAssignment, e)), e.type) {
				...
				case "AssignmentExpression":
					...
					break;
				case "ParenthesizedExpression": this.toAssignable(s, t);
			}
		}
		...
		tsParseDeclaration(t, s, i, r) {
			switch (s) {
				...
				case 124:
					...
					break;
				case 126: if (this.tsCheckLineTerminator(i) && C(this.state.type)) return this.tsParseTypeAliasDeclaration(t);
			}
		}
...
//#endregion
init_babel();
export { ei as default, init_babel as n, Aa as parsers, babel_exports as t };
