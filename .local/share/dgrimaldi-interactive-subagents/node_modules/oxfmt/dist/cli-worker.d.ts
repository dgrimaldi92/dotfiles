 ...
 */
export declare function formatFile({ code, options }: FormatFileParam): Promise<string>;
 ...
 */
export declare function formatEmbeddedCode({ code, options }: FormatEmbeddedCodeParam): Promise<string>;
 ...
 */
export declare function formatEmbeddedDoc({ code, options }: FormatEmbeddedDocParam): Promise<string>;
 ...
 */
export declare function sortTailwindClasses({ classes, options }: SortTailwindClassesArgs): Promise<string[]>;
//#endregion