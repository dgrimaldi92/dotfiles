import { a as __toESM, i as __require, n as __esmMin, t as __commonJSMin } from "./chunk-DYuqS7OD-VvDCD-tt.js";
import { u as bigSign } from "./sorter-QVzKlGeP.js";
import { t as createJiti } from "./jiti-D-zwvB-L-Cp-Q6Ij2.js";
import { fileURLToPath, pathToFileURL } from "node:url";
import * as path from "node:path";
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.19faf8b_prettier-plugin-svelte@4.1.1_prettie_27a8647e85e15dc9997dcc9091e60346/node_modules/prettier-plugin-tailwindcss/dist/v3-DB68zi9w.mjs
var getFilename;
var __filename;
...
var require_clear_module = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	const isNativeModule = (filePath) => path$1.extname(filePath) === ".node";
	const clear = (moduleId) => {
		...
		if (!filePath) return;
		if (isNativeModule(filePath)) return;
	...
	clear.all = () => {
		for (const filePath of Object.keys(__require.cache)) if (!isNativeModule(filePath)) delete __require.cache[filePath];
	};
	clear.match = (regex) => {
	...
	clear.single = (moduleId) => {
		if (typeof moduleId !== "string") throw new TypeError(`Expected a \`string\`, got \`${typeof moduleId}\``);
		const filePath = resolve(moduleId);
		if (!filePath || isNativeModule(filePath)) return;
		delete __require.cache[filePath];
	};
...
var require_previous_map = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	let { existsSync, readFileSync, realpathSync } = __require("fs");
	let { dirname: dirname$1, isAbsolute: isAbsolute$1, join, relative: relative$1, sep: sep$1 } = __require("path");
...
var require_node$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var cloneNode = function cloneNode(obj, parent, depth) {
		...
		if (depth > _util.MAX_NESTING_DEPTH) throw new Error("Cannot clone selector: nesting depth exceeds the maximum of " + _util.MAX_NESTING_DEPTH + ".");
...
var require_container = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	exports["default"] = /* @__PURE__ */ function(_Node) {
		...
		_proto.walk = function walk(callback, depth) {
			if (depth === void 0) depth = 0;
			if (depth > _util.MAX_NESTING_DEPTH) throw new Error("Cannot walk selector: nesting depth exceeds the maximum of " + _util.MAX_NESTING_DEPTH + ".");
