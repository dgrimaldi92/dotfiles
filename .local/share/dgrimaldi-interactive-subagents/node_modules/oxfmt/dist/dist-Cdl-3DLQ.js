...
import { n as init_babel, parsers as Aa, t as babel_exports } from "./babel-BNo95XGj.js";
import index_exports, { t as init_prettier } from "./prettier-CJP-2uP1.js";
import { a as __toESM$1, t as __commonJSMin } from "./chunk-DYuqS7OD-VvDCD-tt.js";
import { c as sortClasses, d as cacheForDirs, f as spliceChangesIntoString, getTailwindConfig as getTailwindConfig$1, l as warn, n as loadIfExists, o as error, p as visit, r as maybeResolve, s as sortClassList, t as expiringMap } from "./sorter-QVzKlGeP.js";
import { parsers as Cn, t as init_angular } from "./angular-BNqhpOOn.js";
import { n as postcss_exports, parsers as cn, t as init_postcss } from "./postcss-DQ37ghU5.js";
import * as path from "node:path";
import { isAbsolute } from "path";
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.19faf8b_prettier-plugin-svelte@4.1.1_prettie_27a8647e85e15dc9997dcc9091e60346/node_modules/prettier-plugin-tailwindcss/dist/index.mjs
init_angular();
init_babel();
init_postcss();
init_prettier();
...
const { parsers, printers } = createPlugin([
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./html-DJ7xvkyA.js")
		}],
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./glimmer-BR6sIcOr.js")
		}],
		parsers: { glimmer: {} },
	...
	defineTransform({
		...
		parsers: {
			...
			typescript: { load: [{
				...
				importer: () => import("./typescript-58lui7HM.js")
			}] },
			meriyah: { load: [{
				name: "prettier/plugins/meriyah",
				importer: () => import("./meriyah--O9OPfEs.js")
			}] },
			acorn: { load: [{
				name: "prettier/plugins/acorn",
				importer: () => import("./acorn-rEwvRUzq.js")
			}] },
			flow: { load: [{
				name: "prettier/plugins/flow",
				importer: () => import("./flow-D4ILzALw.js")
			}] },
			oxc: { load: [{
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./plugin-Cv_4v-MS.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))
		}],
		parsers: { svelte: {} },
		printers: { "svelte-ast": {} },
