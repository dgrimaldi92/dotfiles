...
import { n as runCli } from "./bindings-nN4-lI18.js";
...
(async () => {
	...
	if (mode === "migrate:prettier") {
		await import("./migrate-prettier-0qiqbby6.js").then((m) => m.runMigratePrettier());
		return;
	}
	...
	if (!(major === 24 && (minor > 13 || minor === 13 && patch >= 1)) && (major < 25 || major === 25 && minor < 4)) setTimeout(() => process.exit(), 50);
})();
//#endregion
export {};
