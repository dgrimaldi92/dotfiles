import { r as __exportAll } from "./chunk-DYuqS7OD-VvDCD-tt.js";
import { a as resolveJsFrom, i as resolveCssFrom } from "./sorter-QVzKlGeP.js";
import { t as createJiti } from "./jiti-D-zwvB-L-Cp-Q6Ij2.js";
import { pathToFileURL } from "node:url";
import * as path from "node:path";
import * as fs from "node:fs/promises";
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.19faf8b_prettier-plugin-svelte@4.1.1_prettie_27a8647e85e15dc9997dcc9091e60346/node_modules/prettier-plugin-tailwindcss/dist/v4-C_Jgigaj.mjs
var o = {
	inherit: "inherit",
...
var U$1 = /^(rgba?|hsla?|hwb|color|(ok)?(lab|lch)|light-dark|color-mix|--alpha)\(/i;
function N(e) {
...
var E = /* @__PURE__ */ new Uint8Array(256);
function d(e, t) {
...
function oe(e, i = !1) {
	...
	for (let t of e) switch (t.kind) {
		...
		case "compound":
			r += oe(t.nodes, i);
			break;
		case "list": r += t.nodes.map((n) => oe([n], i)).join(i ? "," : ", ");
	}
	return r;
}
var Cr = 92;
...
var Jt = /* @__PURE__ */ new Uint8Array(256);
function ye(e) {
	let i = 0, r = e.length;
	for (let t = 0; t < r; t++) {
...
var zn = new U((e) => {
	let i = M(e), r = /* @__PURE__ */ new Set(), t = /* @__PURE__ */ new Set([
		"~",
		">",
		"+",
		"-",
...
function ae(e, i, r) {
	...
	switch (e.value.value) {
		...
		case "current":
			t = "currentcolor";
			break;
		default: t = i.resolve(e.value.value, r);
	}
		...
		if (n.kind === "word" && n.value !== "0") {
			...
			switch (d) {
				...
				case "-":
					if (c[1] === p[1]) return t = !0, V.ReplaceSkip(ne(`${c[0] - p[0]}${c[1] ?? ""}`));
					break;
				case "/": if (p[0] !== 0 && (c[1] === null && p[1] === null || c[1] !== null && p[1] === null)) {
					let m = c[0] / p[0];
...
var Wl = /* @__PURE__ */ new Map([[/^(-)?start-(.*?)$/, "$1inset-s-$2"], [/^(-)?end-(.*?)$/, "$1inset-e-$2"]]);
function* Bl(e) {
	let i = Fl.get(e);
	i && (yield i);
	for (let [r, t] of Wl) {
			...
			if (c.has(m)) {
				...
				throw m.kind === "at-rule" && m.name === "@utility" && v.kind === "at-rule" && v.name === "@utility" && P(m.nodes, (h) => {
					...
					for (let y of k) for (let S of i.parseCandidate(y)) switch (S.kind) {
						...
						case "static":
						case "functional": if (v.params.replace(/-\*$/, "") === S.root) throw new Error(`You cannot \`@apply\` the \`${y}\` utility here because it creates a circular dependency.`);
					}
