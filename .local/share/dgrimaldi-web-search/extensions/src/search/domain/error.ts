import type { SearchWebError } from "@/search/composition/web-search";
import type { ParseSearchQueryError } from "@/search/domain/types";
import type { ToolOutputStoreError } from "@/search/presentation/agent-view";
