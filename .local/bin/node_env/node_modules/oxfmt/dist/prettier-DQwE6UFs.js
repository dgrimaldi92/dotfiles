...
import v8 from "v8";
//#region ../../node_modules/.pnpm/prettier@3.9.6/node_modules/prettier/doc.mjs
...
function makeAlign(indent2, indentOptions, options) {
	...
	if (typeof indentOptions === "number") {
		if (indentOptions < 0) command = INDENT_COMMAND_DEDENT;
		else command = {
	...
	while (remainingWidth >= 0) {
		...
		switch (docType) {
			...
			case DOC_TYPE_LINE_SUFFIX$1:
				hasLineSuffix = true;
				break;
			case DOC_TYPE_LINE_SUFFIX_BOUNDARY$1: if (hasLineSuffix) return false;
		}
	}
	return false;
}
...
//#endregion
//#region ../../node_modules/.pnpm/prettier@3.9.6/node_modules/prettier/index.mjs
	...
	function diffLinesResultToPatch(diff) {
		...
		for (let i = 0; i < diff.length; i++) {
			...
			if (current.added || current.removed) {
				...
				if (oldRangeStart) {
					if (lines.length <= context * 2 && i < diff.length - 2) for (const line3 of contextLines(lines)) curRange.push(line3);
					else {
...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-BjTMAHnN.js"));
	try {
...
function attachComments(ast, options7) {
	...
	for (const [index, context] of decoratedComments.entries()) {
		...
		if (placement === "ownLine") {
			if (handleOwnLineComment(...args)) {} else if (followingNode) addLeadingComment(followingNode, comment);
			...
			if (handleEndOfLineComment(...args)) {} else if (precedingNode) addTrailingComment(precedingNode, comment);
...
function printLeadingComment(path17, options7) {
	...
	if (printer.isBlockComment?.(comment)) {
		...
		if (has_newline_default(originalText, locEnd(comment))) {
			if (has_newline_default(originalText, locStart(comment), { backwards: true })) lineBreak = hardline;
...
function callPluginPrintFunction(path17, options7, printPath, args, embeds) {
	...
	switch (node) {
		...
		case options7.nodeBeforeCursor:
			...
			break;
		case options7.nodeAfterCursor: doc2 = inheritLabel(doc2, (doc3) => [cursor, doc3]);
	}
...
var init_prettier = __esmMin((() => {
	...
	require_parse2 = __commonJS({ "node_modules/micromatch/node_modules/picomatch/lib/parse.js"(exports, module) {
		...
		var parse10 = (input, options7) => {
			...
			if (opts2.fastpaths !== false && !/(^[*!]|[/()[\]{}"])/.test(input)) {
				...
				if (backslashes === true) {
					if (opts2.unescape === true) output = output.replace(/\\/g, "");
	...
	require_picomatch = __commonJS({ "node_modules/micromatch/node_modules/picomatch/lib/picomatch.js"(exports, module) {
		...
		picomatch.test = (input, regex, options7, { glob, posix } = {}) => {
			...
			if (match2 === false || opts2.capture === true) {
				if (opts2.matchBase === true || opts2.basename === true) match2 = picomatch.matchBase(input, regex, options7, posix);
	...
	require_merge2 = __commonJS({ "node_modules/merge2/index.js"(exports, module) {
		...
		function merge2() {
			...
			if (options7.highWaterMark == null) options7.highWaterMark = 65536;
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			name: "acorn",
			load: () => import("./acorn-BOnijGC_.js"),
			parsers: ["acorn", "espree"]
		}, {
			name: "angular",
			load: () => import("./angular-CkW6y8HF.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_directive",
			...
			name: "markdown",
			load: () => import("./markdown-CQ2u3qzg.js"),
			...
			name: "meriyah",
			load: () => import("./meriyah-DueWK4fU.js"),
			parsers: ["meriyah"]
		}, {
			name: "postcss",
			load: () => import("./postcss-DG3ZTIYn.js"),
			...
			name: "typescript",
			load: () => import("./typescript-v0Fn_27B.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
			load: () => import("./yaml-BjTMAHnN.js"),
...
${codeblock}`, options7);
	...
	LineByLine = class {
		...
		_readChunk(lineLeftovers) {
			...
			if (totalBytesRead) {
				...
				if (lineLeftovers) {
					if (this.linesCache.length > 0) this.linesCache[0] = Buffer.concat([lineLeftovers, this.linesCache[0]]);
	...
	version_evaluate_default = "3.9.6";
	public_exports = {};
...
//#endregion
init_prettier();
export { debugApis as __debug, sharedWithCli as __internal, check, clearCache3 as clearConfigCache, index_exports as default, doc_exports as doc, format2 as format, formatWithCursor2 as formatWithCursor, get_file_info_default as getFileInfo, getSupportInfo2 as getSupportInfo, prettier_exports as n, resolveConfig, resolveConfigFile, init_prettier as t, public_exports as util, version_evaluate_default as version };
