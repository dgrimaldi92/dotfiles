...
import index_exports, { t as init_prettier } from "./prettier-DQwE6UFs.js";
import { a as __toESM$1, t as __commonJSMin } from "./chunk-DSjvVL_1-BJd7wpp8.js";
import { a as sortClasses, c as cacheForDirs, d as expiringMap, f as loadIfExists, i as sortClassList, l as spliceChangesIntoString, n as error, o as warn, p as maybeResolve, r as getTailwindConfig$1, u as visit } from "./sorter-BZkvDMjt-DALfQQVw.js";
...
//#region ../../node_modules/.pnpm/prettier-plugin-tailwindcss@0.0.0-insiders.2b6f3c2_prettier-plugin-svelte@4.1.1_prettie_45d55a3519d58b621ac22a7f44425cc8/node_modules/prettier-plugin-tailwindcss/dist/index.mjs
init_angular();
init_babel();
init_postcss();
init_prettier();
...
const { parsers, printers } = createPlugin([
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./html-JlR8g6BM.js")
		}],
	...
	defineTransform({
		...
		parsers: {
			...
			typescript: { load: [{
				...
				importer: () => import("./typescript-v0Fn_27B.js")
			}] },
			meriyah: { load: [{
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./plugin-D0HeBk_g.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))
		}],
		parsers: { svelte: {} },
		printers: { "svelte-ast": {} },
